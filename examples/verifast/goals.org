...
| forall_append              | forall a (l1 l2 : list a) p. foreach (append l1 l2) p = (foreach l1 p && foreach l2 p).                                                                               |
| forall_mem                 | forall a (x : a) (l : list a) p. foreach l p = true && mem x l = true => p x = true.                                                                                  |
| forall_drop                | forall a (l : list a) p i. foreach l p = true => foreach (drop i l) p = true.                                                                                         |
...
| foreach_remove_nth         | forall a n (l : list a) p. foreach l p && 0 <= n && n < length l => foreach (remove_nth n l) p && p (nth n l).                                                          |
| foreach_unremove_nth       | forall a n (l : list a) p. 0 <= n && n < length l && foreach (remove_nth n l) p && p (nth n l) => foreach l p.                                                        |
| foreachp_remove            | forall a (x : a) (l : list a) p. foreachp l p && mem x l = true => foreachp (remove x l) p && p x.                                                                    |
| foreachp_unremove          | forall a (x : a) (l : list a) p. foreachp (remove x l) p && mem x l = true && p x => foreachp l p.                                                                    |
| foreachp_remove_nth        | forall a n (l : list a) p. foreachp l p && 0 <= n && n < length l => foreachp (remove_nth n l) p && p (nth n l).                                                      |
| foreachp_unremove_nth      | forall a (l : list a) n p. foreachp (remove_nth n l) p && 0 <= n && n < length l && p (nth n l) => foreachp l p.                                                      |
