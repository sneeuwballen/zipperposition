...
% Relevant facts (3)
thf(fact_0_assms__3_I3_J, axiom,
    ((![C : $tType]: (![X : C, Y : C]: ((p @ (C) @ X @ Y) | (~ ((r @ (C) @ Y)))))))). % assms_3(3)
thf(fact_1_assms__3_I2_J, axiom,
    ((![B : $tType]: (![X : B, Y : B]: ((p @ (B) @ X @ Y) | (~ ((q @ (B) @ X)))))))). % assms_3(2)
thf(fact_2_assms__3_I1_J, axiom,
    ((![A : $tType]: (![X : A, Y : A]: ((~ ((p @ (A) @ X @ Y))) | ((q @ (A) @ X) | (r @ (A) @ Y))))))). % assms_3(1)
