...
% Relevant facts (3)
thf(fact_0_assms__11_I3_J, axiom,
    (((x @ (product_unit)) = (y @ (product_unit))))). % assms_11(3)
thf(fact_1_assms__11_I2_J, axiom,
    ((![A : $tType]: ((~ ((p @ ((product_prod @ nat @ A)) @ (f @ ((product_prod @ nat @ A)) @ (x @ ((product_prod @ nat @ A))))))) | (q @ (A) @ (w @ (A))))))). % assms_11(2)
thf(fact_2_assms__11_I1_J, axiom,
    ((![A : $tType]: (![X : (product_prod @ A @ int)]: ((q @ (A) @ (u @ (A))) | ((q @ (A) @ (v @ (A))) | (p @ ((product_prod @ A @ int)) @ X))))))). % assms_11(1)
