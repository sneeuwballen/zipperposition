...
% Relevant facts (3)
thf(fact_0_assms__27_I3_J, axiom,
    ((![A : $tType]: ((a @ (A)) = (b @ (A)))))). % assms_27(3)
thf(fact_1_assms__27_I2_J, axiom,
    (((p @ ((nat > nat) > $o) @ (^[X : nat]: X)) | (~ ((q @ ($o))))))). % assms_27(2)
thf(fact_2_assms__27_I1_J, axiom,
    ((![Y : nat > $o]: ((~ ((p @ ((nat > nat) > $o) @ (^[X : nat]: X)))) | ((q @ ($o)) | (Y @ (a @ (nat)))))))). % assms_27(1)
