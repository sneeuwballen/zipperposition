...
% Relevant facts (3)
thf(fact_0_assms__14_I3_J, axiom,
    ((![A : $tType]: (![C : A, D : A]: (C = D))))). % assms_14(3)
thf(fact_1_assms__14_I2_J, axiom,
    (((p @ (nat > $o) @ (b @ (nat))) | (~ ((q @ (nat > $o) @ (b @ (nat)))))))). % assms_14(2)
thf(fact_2_assms__14_I1_J, axiom,
    (((~ ((p @ (nat > $o) @ (a @ (nat))))) | (q @ (nat > $o) @ (a @ (nat)))))). % assms_14(1)
