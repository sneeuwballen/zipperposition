...
% Relevant facts (2)
thf(fact_0_assms__26_I2_J, axiom,
    (((p @ ((nat > nat) > $o) @ (^[X : nat]: X)) | (~ ((q @ ($o))))))). % assms_26(2)
thf(fact_1_assms__26_I1_J, axiom,
    ((![Y : nat > $o]: ((~ ((p @ ((nat > nat) > $o) @ (^[X : nat]: X)))) | ((q @ ($o)) | (Y @ (a @ (nat)))))))). % assms_26(1)
