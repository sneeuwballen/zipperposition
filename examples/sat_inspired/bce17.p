...
% Relevant facts (2)
thf(fact_0_assms__17_I2_J, axiom,
    ((((p0 @ (nat)) = (a @ (nat))) | ((q0 @ (nat)) != (a @ (nat)))))). % assms_17(2)
thf(fact_1_assms__17_I1_J, axiom,
    ((((p0 @ (nat)) != (a @ (nat))) | ((q0 @ (nat)) = (a @ (nat)))))). % assms_17(1)
