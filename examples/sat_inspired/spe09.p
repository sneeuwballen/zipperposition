...
% Relevant facts (3)
thf(fact_0_assms__9_I3_J, axiom,
    ((![A : $tType]: (q @ (A) @ (x @ (A)))))). % assms_9(3)
thf(fact_1_assms__9_I2_J, axiom,
    ((![A : $tType]: ((~ ((p @ ((product_prod @ nat @ A)) @ (f @ ((product_prod @ nat @ A)) @ (x @ ((product_prod @ nat @ A))))))) | (q @ (A) @ (w @ (A))))))). % assms_9(2)
thf(fact_2_assms__9_I1_J, axiom,
    ((![A : $tType]: ((q @ (A) @ (u @ (A))) | ((q @ (A) @ (v @ (A))) | (p @ ((product_prod @ A @ int)) @ (x @ ((product_prod @ A @ int))))))))). % assms_9(1)
