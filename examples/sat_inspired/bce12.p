...
% Relevant facts (3)
thf(fact_0_assms__12_I3_J, axiom,
    ((![A : $tType]: ((a @ (A)) = (b @ (A)))))). % assms_12(3)
thf(fact_1_assms__12_I2_J, axiom,
    (((p0 @ ($o)) | (~ ((q0 @ ($o))))))). % assms_12(2)
thf(fact_2_assms__12_I1_J, axiom,
    (((~ ((p0 @ ($o)))) | (q0 @ ($o))))). % assms_12(1)
