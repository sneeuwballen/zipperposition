...
thf(fact_1_assms__7_I3_J, axiom,
    ((![F : $tType, G : $tType]: (![X : F, Y : G]: ((p @ (F) @ (G) @ X @ Y) | ((r @ (G) @ Y) != (e @ (G)))))))). % assms_7(3)
thf(fact_2_assms__7_I2_J, axiom,
    ((![E : $tType, D : $tType]: (![X : D, Y : E]: ((p @ (D) @ (E) @ X @ Y) | ((q @ (D) @ X) != (e @ (D)))))))). % assms_7(2)
thf(fact_3_assms__7_I1_J, axiom,
    ((![B : $tType, C : $tType]: (![X : B, Y : C]: ((~ ((p @ (B) @ (C) @ X @ Y))) | (((q @ (B) @ X) = (e @ (B))) | ((r @ (C) @ Y) = (e @ (C))))))))). % assms_7(1)
