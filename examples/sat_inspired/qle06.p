...
thf(fact_0_assms__6_I3_J, axiom,
    ((![D : $tType, E : $tType]: (~ ((q @ (D) @ (E > $o) @ (a @ (D)) @ (a @ (E)))))))). % assms_6(3)
thf(fact_1_assms__6_I2_J, axiom,
    ((![C : $tType, A : $tType]: (![F : A > C, X : A]: (p @ (C) @ (F @ X)))))). % assms_6(2)
thf(fact_2_assms__6_I1_J, axiom,
    ((![B : $tType, A : $tType]: (![X : A]: ((p @ (A) @ X) | (q @ (B) @ (A > $o) @ (a @ (B)) @ X)))))). % assms_6(1)
