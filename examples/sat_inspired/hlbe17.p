...
% Relevant facts (3)
thf(fact_0_assms__17_I3_J, axiom,
    (((cyan @ (nat) @ z) | ((blue @ (nat) @ z) | (yellow @ (nat) @ z))))). % assms_17(3)
thf(fact_1_assms__17_I2_J, axiom,
    (((cyan @ (nat) @ z) => (green @ (nat) @ z)))). % assms_17(2)
thf(fact_2_assms__17_I1_J, axiom,
    (((cyan @ (nat) @ z) => (blue @ (nat) @ z)))). % assms_17(1)
