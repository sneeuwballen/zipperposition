...
% Relevant facts (5)
thf(fact_0_assms__23_I5_J, axiom,
    ((![K : $tType]: ((a2 @ (K)) = (b2 @ (K)))))). % assms_23(5)
thf(fact_1_assms__23_I4_J, axiom,
    ((![I : $tType, J : $tType]: (![X : I, Y : J > $o]: ((p @ (I) @ (J > $o) @ X @ Y) | (~ ((Y @ (a2 @ (J)))))))))). % assms_23(4)
thf(fact_2_assms__23_I3_J, axiom,
    ((![G : $tType, H : $tType]: (![X : G, Y : H]: ((p @ (G) @ (H) @ X @ Y) | ((r @ (H) @ Y) != (e2 @ (H)))))))). % assms_23(3)
thf(fact_3_assms__23_I2_J, axiom,
    ((![E : $tType, F : $tType, D : $tType]: (![X : D, Y : E]: ((p @ (D) @ (E) @ X @ Y) | ((q @ ((D > F) > F) @ (^[Y2 : D > F]: (Y2 @ X))) != (e2 @ ((D > F) > F)))))))). % assms_23(2)
thf(fact_4_assms__23_I1_J, axiom,
    ((![C : $tType, A : $tType, B : $tType]: (![X : A, Y : B > $o]: ((~ ((p @ (A) @ (B > $o) @ X @ Y))) | (((q @ ((A > C) > C) @ (^[Y2 : A > C]: (Y2 @ X))) = (e2 @ ((A > C) > C))) | (((r @ (B > $o) @ Y) = (e2 @ (B > $o))) | (Y @ (a2 @ (B)))))))))). % assms_23(1)
