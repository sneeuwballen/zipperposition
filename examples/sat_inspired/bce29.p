...
% Relevant facts (3)
thf(fact_0_assms__29_I3_J, axiom,
    ((![B : $tType]: (![C : B, D : B]: (C = D))))). % assms_29(3)
thf(fact_1_assms__29_I2_J, axiom,
    (((p2 @ (nat > nat) @ (nat) @ (^[X : nat]: X) @ (b @ (nat))) | (~ ((q @ (nat) @ (b @ (nat)))))))). % assms_29(2)
thf(fact_2_assms__29_I1_J, axiom,
    ((![A : $tType]: (![Y : A > $o]: ((~ ((p2 @ (nat > nat) @ (nat) @ (^[X : nat]: X) @ (a @ (nat))))) | ((q @ (nat) @ (a @ (nat))) | (Y @ (a @ (A))))))))). % assms_29(1)
