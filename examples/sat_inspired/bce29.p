...
thf(fact_1_assms__29_I2_J, axiom,
    (((p @ ((nat > nat) > nat > $o) @ (^[X : nat]: X) @ (b @ (nat))) | (~ ((q @ (nat > $o) @ (b @ (nat)))))))). % assms_29(2)
thf(fact_2_assms__29_I1_J, axiom,
    ((![A : $tType]: (![Y : A > $o]: ((~ ((p @ ((nat > nat) > nat > $o) @ (^[X : nat]: X) @ (a @ (nat))))) | ((q @ (nat > $o) @ (a @ (nat))) | (Y @ (a @ (A))))))))). % assms_29(1)
