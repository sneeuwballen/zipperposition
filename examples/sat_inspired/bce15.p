...
% Relevant facts (3)
thf(fact_0_assms__15_I3_J, axiom,
    ((![A : $tType]: (![D : A, E : A]: (D = E))))). % assms_15(3)
thf(fact_1_assms__15_I2_J, axiom,
    ((![C : nat]: ((p @ (nat > $o) @ (b @ (nat))) | (~ ((q @ (nat > $o) @ C))))))). % assms_15(2)
thf(fact_2_assms__15_I1_J, axiom,
    (((~ ((p @ (nat > $o) @ (a @ (nat))))) | (q @ (nat > $o) @ (a @ (nat)))))). % assms_15(1)
