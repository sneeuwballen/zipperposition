...
thf(fact_2_assms__9_I3_J, axiom,
    ((![F : $tType, G : $tType]: (![X : F, Y : G]: ((p @ (F) @ (G) @ X @ Y) | (~ ((r @ (G) @ Y)))))))). % assms_9(3)
thf(fact_3_assms__9_I2_J, axiom,
    ((![E : $tType, D : $tType]: (![X : D, Y : E]: ((p @ (D) @ (E) @ X @ Y) | (~ ((q @ (D) @ X)))))))). % assms_9(2)
thf(fact_4_assms__9_I1_J, axiom,
    ((![B : $tType, C : $tType]: (![X : B, Y : C]: ((~ ((p @ (B) @ (C) @ X @ Y))) | ((q @ (B) @ X) | (r @ (C) @ Y))))))). % assms_9(1)
