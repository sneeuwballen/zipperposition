...
thf(fact_1_assms_I5_J, axiom,
    ((![Z : e > $o]: ((Z @ e_e) | ((p @ (^[X : a]: (f @ X @ X)) @ b2) | (~ ((p @ c2 @ d2)))))))). % assms(5)
thf(fact_2_assms_I4_J, axiom,
    ((![X2 : a > $o, Y : a > $o]: ((p @ X2 @ Y) | (~ ((Y @ a2))))))). % assms(4)
thf(fact_3_assms_I3_J, axiom,
    ((![X2 : a > $o, Y : a > $o]: ((p @ X2 @ Y) | ((r @ Y) != e_d))))). % assms(3)
thf(fact_4_assms_I2_J, axiom,
    ((![X2 : a > $o, Y : a > $o]: ((p @ X2 @ Y) | ((q @ (^[Y2 : (a > $o) > c]: (Y2 @ X2))) != e_b))))). % assms(2)
thf(fact_5_assms_I1_J, axiom,
    ((![X2 : a > $o, Y : a > $o]: ((~ ((p @ X2 @ Y))) | (((q @ (^[Y2 : (a > $o) > c]: (Y2 @ X2))) = e_b) | (((r @ Y) = e_d) | (Y @ a2))))))). % assms(1)
