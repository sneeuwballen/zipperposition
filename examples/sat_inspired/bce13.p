...
% Relevant facts (3)
thf(fact_0_assms__13_I3_J, axiom,
    (((a @ (nat)) = (b @ (nat))))). % assms_13(3)
thf(fact_1_assms__13_I2_J, axiom,
    (((p @ (nat > $o) @ (b @ (nat))) | (~ ((q @ (nat > $o) @ (b @ (nat)))))))). % assms_13(2)
thf(fact_2_assms__13_I1_J, axiom,
    ((![C : nat]: ((~ ((p @ (nat > $o) @ C))) | ((~ ((p @ (nat > $o) @ (a @ (nat))))) | ((q @ (nat > $o) @ C) | (q @ (nat > $o) @ (a @ (nat))))))))). % assms_13(1)
