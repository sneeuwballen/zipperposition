...
thf(fact_1_assms__30_I2_J, axiom,
    ((![C : nat]: ((p @ ((nat > nat) > nat > $o) @ (^[X : nat]: X) @ (b @ (nat))) | (~ ((q @ (nat > $o) @ C))))))). % assms_30(2)
thf(fact_2_assms__30_I1_J, axiom,
    ((![A : $tType]: (![Y : A > $o]: ((~ ((p @ ((nat > nat) > nat > $o) @ (^[X : nat]: X) @ (a @ (nat))))) | ((q @ (nat > $o) @ (a @ (nat))) | (Y @ (a @ (A))))))))). % assms_30(1)
