...
thf(sy_c_HLBE_Oa, type,
    a : !>[A : $tType]: A).
thf(sy_c_HLBE_Os, type,
    s : !>[A : $tType]: A).
thf(sy_c_HLBE_Ot, type,
    t : !>[A : $tType]: A).
thf(sy_c_HLBE_Ou, type,
    u : !>[A : $tType]: A).

% Relevant facts (1)
thf(fact_0_assms__20, axiom,
    ((![A : $tType]: (![C : $o]: (((s @ (nat)) != (t @ (nat))) | (((u @ (nat > nat > A) @ (s @ (nat)) @ (a @ (nat))) != (u @ (nat > nat > A) @ (t @ (nat)) @ (a @ (nat)))) | C)))))). % assms_20
