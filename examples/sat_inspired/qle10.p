...
thf(sy_c_QLE_Or, type,
    r : !>[A : $tType]: A).

% Relevant facts (4)
thf(fact_0_assms__10_I4_J, axiom,
    ((r @ ($o)))). % assms_10(4)
thf(fact_1_assms__10_I3_J, axiom,
    ((![C : $tType]: ((p @ (C)) != (q @ (C) @ ($o)))))). % assms_10(3)
thf(fact_2_assms__10_I2_J, axiom,
    ((![B : $tType]: ((p @ (B)) = (q @ (B) @ ($o)))))). % assms_10(2)
thf(fact_3_assms__10_I1_J, axiom,
    ((![A : $tType]: (p @ (A) @ (a @ (A)))))). % assms_10(1)
