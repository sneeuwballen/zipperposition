...
% Relevant facts (2)
thf(fact_0_assms__7_I2_J, axiom,
    ((![C : $tType, B : $tType]: (![X : B, F : B > C]: ((~ ((p @ (B) @ X))) | (p @ (C) @ (F @ X))))))). % assms_7(2)
thf(fact_1_assms__7_I1_J, axiom,
    ((![A : $tType]: (p @ (A) @ (a @ (A)))))). % assms_7(1)
