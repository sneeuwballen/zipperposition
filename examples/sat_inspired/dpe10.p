...
thf(fact_2_assms__10_I3_J, axiom,
    ((![H : $tType, I : $tType]: (![X : H, Y : I]: ((p @ (H) @ (I) @ X @ Y) | ((r @ (I) @ Y) != (e @ (I)))))))). % assms_10(3)
thf(fact_3_assms__10_I2_J, axiom,
    ((![G : $tType, F : $tType]: (![X : F, Y : G]: ((p @ (F) @ (G) @ X @ Y) | ((q @ (F) @ X) != (e @ (F)))))))). % assms_10(2)
thf(fact_4_assms__10_I1_J, axiom,
    ((![D2 : $tType, E : $tType]: (![X : D2, Y : E]: ((~ ((p @ (D2) @ (E) @ X @ Y))) | (((q @ (D2) @ X) = (e @ (D2))) | ((r @ (E) @ Y) = (e @ (E))))))))). % assms_10(1)
