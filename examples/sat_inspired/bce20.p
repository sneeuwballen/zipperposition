...
% Relevant facts (2)
thf(fact_0_assms__20_I2_J, axiom,
    ((![X : nat]: ((~ ((p @ (nat > $o) @ X))) | (q @ ($o)))))). % assms_20(2)
thf(fact_1_assms__20_I1_J, axiom,
    (((p @ (nat > $o) @ (a @ (nat))) | ((p @ (nat > $o) @ (b @ (nat))) | (~ ((q @ ($o)))))))). % assms_20(1)
