...
% Relevant facts (2)
thf(fact_0_assms__19_I2_J, axiom,
    ((![X : nat, Y : nat]: ((~ ((p2 @ (nat) @ (nat) @ X @ Y))) | (~ ((p2 @ (nat) @ (nat) @ Y @ X))))))). % assms_19(2)
thf(fact_1_assms__19_I1_J, axiom,
    ((![X : nat, Y : nat]: ((p2 @ (nat) @ (nat) @ X @ Y) | (p2 @ (nat) @ (nat) @ Y @ X))))). % assms_19(1)
