...
% Relevant facts (4)
thf(fact_0_assms__9_I4_J, axiom,
    ((r @ ($o)))). % assms_9(4)
thf(fact_1_assms__9_I3_J, axiom,
    ((![C : $tType]: (~ ((q @ (C > $o) @ ($o) @ (p @ (C)))))))). % assms_9(3)
thf(fact_2_assms__9_I2_J, axiom,
    ((![B : $tType]: (q @ (B > $o) @ ($o) @ (p @ (B)))))). % assms_9(2)
thf(fact_3_assms__9_I1_J, axiom,
    ((![A : $tType]: (p @ (A) @ (a @ (A)))))). % assms_9(1)
