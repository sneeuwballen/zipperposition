...
thf(fact_1_assms__8_I3_J, axiom,
    ((![E : $tType, F : $tType]: (![X : E, Y : F]: ((p @ (E) @ (F) @ X @ Y) | (~ ((r @ (F) @ Y)))))))). % assms_8(3)
thf(fact_2_assms__8_I2_J, axiom,
    ((![D : $tType, C : $tType]: (![X : C, Y : D]: ((p @ (C) @ (D) @ X @ Y) | (~ ((q @ (C) @ X)))))))). % assms_8(2)
thf(fact_3_assms__8_I1_J, axiom,
    ((![A : $tType, B : $tType]: (![X : A, Y : B]: ((~ ((p @ (A) @ (B) @ X @ Y))) | ((q @ (A) @ X) | (r @ (B) @ Y))))))). % assms_8(1)
