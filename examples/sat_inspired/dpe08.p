...
thf(fact_0_assms__8_I4_J, axiom,
    ((![G : $tType]: ((a @ (G)) = (b @ (G)))))). % assms_8(4)
thf(fact_1_assms__8_I3_J, axiom,
    ((![E : $tType, F : $tType]: (![X : E, Y : F]: ((p @ (E) @ (F) @ X @ Y) | ((r @ (F) @ Y) != (e @ (F)))))))). % assms_8(3)
thf(fact_2_assms__8_I2_J, axiom,
    ((![D : $tType, C : $tType]: (![X : C, Y : D]: ((p @ (C) @ (D) @ X @ Y) | ((q @ (C) @ X) != (e @ (C)))))))). % assms_8(2)
thf(fact_3_assms__8_I1_J, axiom,
    ((![A : $tType, B : $tType]: (![X : A, Y : B]: ((~ ((p @ (A) @ (B) @ X @ Y))) | (((q @ (A) @ X) = (e @ (A))) | ((r @ (B) @ Y) = (e @ (B))))))))). % assms_8(1)
