...
% Relevant facts (5)
thf(fact_0_assms__22_I5_J, axiom,
    ((![K : $tType, L : $tType, M : $tType, N : $tType]: (![Z : K > $o, F : L > L > M]: ((Z @ (e2 @ (K))) | (p @ (L > M) @ (N) @ (^[X : L]: (F @ X @ X)) @ (b2 @ (N)))))))). % assms_22(5)
thf(fact_1_assms__22_I4_J, axiom,
    ((![I : $tType, J : $tType]: (![X2 : I, Y : J > $o]: ((p @ (I) @ (J > $o) @ X2 @ Y) | (~ ((Y @ (a2 @ (J)))))))))). % assms_22(4)
thf(fact_2_assms__22_I3_J, axiom,
    ((![G : $tType, H : $tType]: (![X2 : G, Y : H]: ((p @ (G) @ (H) @ X2 @ Y) | ((r @ (H) @ Y) != (e2 @ (H)))))))). % assms_22(3)
thf(fact_3_assms__22_I2_J, axiom,
    ((![E : $tType, F2 : $tType, D : $tType]: (![X2 : D, Y : E]: ((p @ (D) @ (E) @ X2 @ Y) | ((q @ ((D > F2) > F2) @ (^[Y2 : D > F2]: (Y2 @ X2))) != (e2 @ ((D > F2) > F2)))))))). % assms_22(2)
thf(fact_4_assms__22_I1_J, axiom,
    ((![C : $tType, A : $tType, B : $tType]: (![X2 : A, Y : B > $o]: ((~ ((p @ (A) @ (B > $o) @ X2 @ Y))) | (((q @ ((A > C) > C) @ (^[Y2 : A > C]: (Y2 @ X2))) = (e2 @ ((A > C) > C))) | (((r @ (B > $o) @ Y) = (e2 @ (B > $o))) | (Y @ (a2 @ (B)))))))))). % assms_22(1)
