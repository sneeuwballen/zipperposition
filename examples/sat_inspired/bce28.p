...
thf(fact_1_assms__28_I2_J, axiom,
    ((![D : $tType]: ((p @ ((D > D) > nat > $o) @ (^[X : D]: X) @ (b @ (nat))) | (~ ((q @ (nat > $o) @ (b @ (nat))))))))). % assms_28(2)
thf(fact_2_assms__28_I1_J, axiom,
    ((![C : $tType, B : $tType, A : $tType]: (![C2 : nat, Y : A > $o]: ((~ ((p @ ((B > B) > nat > $o) @ (^[X : B]: X) @ C2))) | ((~ ((p @ ((C > C) > nat > $o) @ (^[X : C]: X) @ (a @ (nat))))) | ((q @ (nat > $o) @ C2) | ((q @ (nat > $o) @ (a @ (nat))) | (Y @ (a @ (A))))))))))). % assms_28(1)
