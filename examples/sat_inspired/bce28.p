...
thf(fact_1_assms__28_I2_J, axiom,
    (((p @ ((nat > nat) > nat > $o) @ (^[X : nat]: X) @ (b @ (nat))) | (~ ((q @ (nat > $o) @ (b @ (nat)))))))). % assms_28(2)
thf(fact_2_assms__28_I1_J, axiom,
    ((![B : $tType, A : $tType]: (![C : nat, Y : A > $o]: ((~ ((p @ ((nat > nat) > nat > $o) @ (^[X : nat]: X) @ C))) | ((~ ((p @ ((B > B) > nat > $o) @ (^[X : B]: X) @ (a @ (nat))))) | ((q @ (nat > $o) @ C) | ((q @ (nat > $o) @ (a @ (nat))) | (Y @ (a @ (A))))))))))). % assms_28(1)
