...
thf(sy_c_HLBE_Oblue, type,
    blue : !>[A : $tType]: (A > $o)).
thf(sy_c_HLBE_Ogray, type,
    gray : !>[A : $tType]: (A > $o)).
thf(sy_c_HLBE_Ogreen, type,
    green : !>[A : $tType]: (A > $o)).
thf(sy_c_HLBE_Ored, type,
    red : !>[A : $tType]: (A > $o)).
thf(sy_c_HLBE_Oyellow, type,
    yellow : !>[A : $tType]: (A > $o)).
thf(sy_c_HLBE_Oz, type,
    z : nat).

% Relevant facts (3)
thf(fact_0_assms__22_I3_J, axiom,
    (((green @ (nat) @ z) | ((blue @ (nat) @ z) | ((yellow @ (nat) @ z) | (red @ (nat) @ z)))))). % assms_22(3)
thf(fact_1_assms__22_I2_J, axiom,
    (((gray @ (nat) @ z) => (blue @ (nat) @ z)))). % assms_22(2)
thf(fact_2_assms__22_I1_J, axiom,
    (((~ ((green @ (nat) @ z))) => (gray @ (nat) @ z)))). % assms_22(1)
