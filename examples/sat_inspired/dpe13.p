...
thf(fact_1_assms_I4_J, axiom,
    ((![X : a, Y : b > $o]: ((p @ X @ Y) | (~ ((Y @ a2))))))). % assms(4)
thf(fact_2_assms_I3_J, axiom,
    ((![X : a, Y : b > $o]: ((p @ X @ Y) | ((r @ Y) != e_e))))). % assms(3)
thf(fact_3_assms_I2_J, axiom,
    ((![X : a, Y : b > $o]: ((p @ X @ Y) | ((q @ (^[Y2 : a > d]: (Y2 @ X))) != e_c))))). % assms(2)
thf(fact_4_assms_I1_J, axiom,
    ((![X : a, Y : b > $o]: ((~ ((p @ X @ Y))) | (((q @ (^[Y2 : a > d]: (Y2 @ X))) = e_c) | (((r @ Y) = e_e) | (Y @ a2))))))). % assms(1)
