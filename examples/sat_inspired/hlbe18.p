...
% Relevant facts (3)
thf(fact_0_assms__18_I3_J, axiom,
    (((blue @ (nat) @ z) | (yellow @ (nat) @ z)))). % assms_18(3)
thf(fact_1_assms__18_I2_J, axiom,
    (((blue @ (nat) @ z) => (~ ((cyan @ (nat) @ z)))))). % assms_18(2)
thf(fact_2_assms__18_I1_J, axiom,
    (((blue @ (nat) @ z) => (cyan @ (nat) @ z)))). % assms_18(1)
