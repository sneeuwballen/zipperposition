(* OASIS_START *)
(* DO NOT EDIT (digest: 43d8d5b8cb27af64ba12e1ae0eddce4f) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [
          ...
          ("libzipperposition", ["src/prover"; "src/prover/calculi"], [])
       ];
     lib_c = [("logtk", "src/core/", ["src/core/util_stubs.h"])];
     flags =
       [
     ...
     includes =
       [
          ("tests/bench", ["src/arbitrary"; "src/core"; "src/core/lib"]);
          ("tests",
            ["src/arbitrary"; "src/core"; "src/core/lib"; "src/parsers"]);
          ("src/tools/orient",
            ["src/core"; "src/core/lib"; "src/parsers"; "src/solving"]);
          ("src/tools", ["src/core"; "src/core/lib"; "src/parsers"]);
          ...
          ("src/hornet", ["src/core"; "src/core/lib"; "src/parsers"]);
          ("src/demo/resolution",
