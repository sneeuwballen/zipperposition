...
(* OASIS_START *)
(* DO NOT EDIT (digest: ad53627c2b90051d26b7611abea63fdd) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "check_tptp.ml"; });
               Executable
                 ({
                     cs_name = "cnf_of_tptp";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "!\184\018Z\181\213\243\229\171\030R\155\223P0u";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
