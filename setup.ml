               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src/proofs";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "logtk"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {
                      lib_modules =
                        ["LLProof"; "LLProof_conv"; "LLProof_check"; "LLTerm"
                        ];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "logtk";
                      lib_findlib_name = Some "proofs";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
