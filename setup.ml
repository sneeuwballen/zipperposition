...
(* OASIS_START *)
(* DO NOT EDIT (digest: c522b6e58f1c04dd3aa4f34f4acc72cb) *)
(*
...
let setup_t =
  {
               ...
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "Build and install constraint solvers (requires \"sat\")";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\193\142\022`ki\243{\004\017\017\253\160\017k\152";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
