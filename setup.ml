...
(* OASIS_START *)
(* DO NOT EDIT (digest: b07e39efdc0a674b5c6c4d3f32018acf) *)
(*
...
let setup_t =
  {
     ...
     doc = [("logtk", OCamlbuildDocPlugin.doc_build ".")];
     ...
     clean_doc = [("logtk", OCamlbuildDocPlugin.doc_clean ".")];
     distclean = [];
     distclean_test =
       [
          ("all",
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Parse_tptp"; "Lex_tptp"; "Ast_tptp"; "Util_tptp"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "logtk";
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\019\237\0034`9\026\207\227b\247\179\211b\236\024";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
