...
(* OASIS_START *)
(* DO NOT EDIT (digest: 908ebbe2b1ff4b888c31aceffc493647) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("make", ["frogtest"]))];
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Test the prover against a set of problems";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
               ...
               Flag
                 ({
                     cs_name = "zipperposition_prover";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      flag_description =
                        Some "Build and install Zipperposition";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Flag
                 ({
                     cs_name = "hornet_prover";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      flag_description = Some "Build and install Hornet";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("tip_parser", None)
                        ];
                      bs_build_tools =
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["ArTerm"; "ArForm"; "ArType"; "ArID"; "ArLiteral"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "logtk";
               ...
               Library
                 ({
                        ...
                        [
                           ...
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "parsers",
                                OASISExpr.EFlag "zipperposition_prover"),
                             true)
                        ];
                      bs_install =
                        [
                   ...
                   },
                   {
                      ...
                      lib_pack = true;
                      lib_internal_modules = ["lib/Simplex"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "libzipperposition";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Executable
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "hornet.ml"});
               Doc
                 ({
                     cs_name = "logtk";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      doc_title = "Documentation for Logtk";
                      doc_authors = [];
                      doc_abstract = Some "Main API documentation for Logtk.";
                      doc_format = OtherDoc;
                      doc_data_files = [];
                      doc_build_tools =
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$docdir";
                      doc_title = "Logtk_parsers documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$docdir";
                      doc_title = "Logtk_arbitrary documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$docdir";
                      doc_title = "Libzipperpositio documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("qcheck", None);
                           InternalLibrary "logtk_arbitrary"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\130\160\168Q\r\157\143\237\146\196AB\232\172bp";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
