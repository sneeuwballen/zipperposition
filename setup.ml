...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7cd4913568d2faf5bbc5ef8b27873d65) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build and install the Extended library";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["lib/MultiMap"; "lib/Mixtbl"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "logtk";
                      lib_findlib_name = Some "extended";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "logtk";
                           InternalLibrary "logtk_extended";
     ...
     oasis_version = "0.4.2";
     oasis_digest = Some "\180\151$h\003P\221\016\182\027\193\167\146\187/@";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
