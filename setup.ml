...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9ca763721198f234b1511c6d7960f338) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          sections =
            [
               ...
               Executable
                 ({
                     cs_name = "zipperposition_quantor";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "zipperposition_quantor.ml"
                   });
               Doc
                 ({
                     cs_name = "libzipperposition";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\b\000\209]\201\236\021J\154\005\149M\221\153>]";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
