...
(* OASIS_START *)
(* DO NOT EDIT (digest: 61e8de8063d310bb76821750bfad0f49) *)
(*
...
let setup_t =
  {
     ...
     build =
       OCamlbuildPlugin.build
         {
            OCamlbuildPlugin.plugin_tags = None;
            extra_args = ["-menhir 'menhir --dump --explain'"]
         };
     test =
       [
          ("all",
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\153\"q\030(^n\144DEn\193|?\183\127";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
