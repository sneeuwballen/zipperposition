...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3f822832a3094a0e4ba45dc71e791708) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Extended library";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
     ...
     oasis_version = "0.4.1";
     oasis_digest =
       Some "\192\146\145\253\024\214\203+\251\1810\218\163\203\194\227";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
