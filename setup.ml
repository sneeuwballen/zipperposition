...
(* OASIS_START *)
(* DO NOT EDIT (digest: 40105ac5b772f2fc05eeb54886847a09) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "Zipperposition is an experimental theorem prover based on superposition. It aims at being flexible and extensible while retaining decent performance (using indexing, for instance)."
              ];
          categories = [];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Enable plugin for the meta-prover";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Use depqbf solver";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Use quantor solver";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("containers.io", None);
                           FindlibPackage ("logtk", None);
                           FindlibPackage ("dynlink", None);
                           FindlibPackage ("qbf", None);
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("logtk", None);
                           FindlibPackage ("logtk.meta", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Library
                 ({
                     cs_name = "libzipperposition_quantor";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Zipperposition_quantor"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "libzipperposition";
               ...
               Library
                 ({
                     cs_name = "libzipperposition_depqbf";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Zipperposition_depqbf"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "libzipperposition";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("unix", None);
                           FindlibPackage ("logtk", None);
                           FindlibPackage ("logtk.parsers", None);
                           FindlibPackage ("dynlink", None);
                           InternalLibrary "libzipperposition"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "Documentation for Zipperposition";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("logtk", None);
                           FindlibPackage ("logtk.parsers", None);
                           FindlibPackage ("logtk.arbitrary", None);
                           InternalLibrary "libzipperposition";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "6m\143s\238\007\255\242\210\190G\007R\192\248\002";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
