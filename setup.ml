...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8c54bc0f537f1a4598e9941edfc00be4) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("./tests/run.ml", []))];
            ...
            OCamlbuildDocPlugin.doc_build
              {
                 OCamlbuildDocPlugin.extra_args =
                   [
                      "-use-ocamlfind";
                      "-docflags '-keep-code -colorize-code -short-functors -charset utf-8'"
                   ];
                 run_path = "."
              });
          ("libzipperposition_meta",
            OCamlbuildDocPlugin.doc_build
              {
                 OCamlbuildDocPlugin.extra_args = ["-use-ocamlfind"];
                 run_path = "."
              });
          ("libzipperposition_parsers",
            OCamlbuildDocPlugin.doc_build
              {
                 OCamlbuildDocPlugin.extra_args = ["-use-ocamlfind"];
                 run_path = "."
              });
          ("libzipperposition_arbitrary",
            OCamlbuildDocPlugin.doc_build
              {
                 OCamlbuildDocPlugin.extra_args = ["-use-ocamlfind"];
                 run_path = "."
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/c-cube/zipperposition";
          synopsis =
          ...
          description =
            Some
              [
                 OASISText.Para
                   "Zipperposition is an experimental theorem prover based on superposition. It aims at being flexible and extensible while retaining decent performance (using indexing, for instance). It ships with a logic toolkit, designed primarily for first-order automated reasoning. It aims at providing basic types and algorithms (terms, unification, orderings, indexing, etc.) that can be factored out of several applications."
              ];
          categories = [];
          ...
          files_ab = ["src/prover/const.ml.ab"];
          sections =
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build and install basic tools (CNF, etc.)";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build and install meta-prover";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build and install parsers (requires menhir)";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "Build and install constraint solvers (requires \"msat\")";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "Build and install the main prover and its library";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build and install QCheck random generators";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build and install demo programs";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                     cs_name = "libzipperposition";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_c_sources = ["util_stubs.c"; "util_stubs.h"];
                      bs_data_files = [];
                      bs_ccopt =
                        [
               ...
               Library
                 ({
                     cs_name = "libzipperposition_parsers";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "libzipperposition"];
                      bs_build_tools =
                   ...
                   },
                   {
                      ...
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "libzipperposition";
                      lib_findlib_name = Some "parsers";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "libzipperposition_meta";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "libzipperposition";
                           InternalLibrary "libzipperposition_parsers"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules =
                        ["Encoding"; "Reasoner"; "Plugin"; "Prover"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "libzipperposition";
                      lib_findlib_name = Some "meta";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "libzipperposition_solving";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "libzipperposition";
                      lib_findlib_name = Some "solving";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "libzipperposition_arbitrary";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "src/arbitrary/";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "libzipperposition";
                           FindlibPackage ("qcheck", None);
                           InternalLibrary "libzipperposition_meta"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules = ["ArTerm"; "ArForm"; "ArType"; "ArID"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "libzipperposition";
                      lib_findlib_name = Some "arbitrary";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "libzipperposition_prover";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   },
                   {
                      lib_modules =
                        [
                           ...
                           "calculi/Heuristics";
                           "calculi/Ind_types";
                           "meta/MetaProverState";
                           "meta/MetaProverState_intf"
                        ];
                      lib_pack = true;
                      lib_internal_modules =
                        ["lib/UnionFind"; "lib/Signal"; "lib/Simplex"];
                      lib_findlib_parent = Some "libzipperposition";
                      lib_findlib_name = Some "prover";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "zipperposition";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "libzipperposition";
                           InternalLibrary "libzipperposition_parsers";
                           InternalLibrary "libzipperposition_prover"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = false; exec_main_is = "zipperposition.ml"});
               Doc
                 ({
                     cs_name = "libzipperposition";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      doc_title = "Documentation for Libzipperposition";
                      doc_authors = [];
                      doc_abstract =
                        Some "Main API documentation for Libzipperposition.";
                      doc_format = OtherDoc;
                      doc_data_files = [];
                      doc_build_tools =
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$docdir";
                      doc_title = "Libzipperposition_meta documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$docdir";
                      doc_title = "Libzipperposition_parsers documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$docdir";
                      doc_title = "Libzipperposition_arbitrary documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$docdir";
                      doc_title = "Libzipperposition_prover documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("qcheck", None);
                           InternalLibrary "libzipperposition_arbitrary"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "type_check.ml"});
               Executable
                 ({
                     cs_name = "cnf_of";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "tptp_to_zf.ml"});
               Executable
                 ({
                     cs_name = "orient";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_path = "src/tools/orient/";
                      bs_compiled_object = Native;
                      bs_build_depends =
                        [
                           InternalLibrary "libzipperposition";
                           InternalLibrary "libzipperposition_parsers";
                           InternalLibrary "libzipperposition_solving";
                           FindlibPackage ("msat", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                   ...
                   {exec_custom = false; exec_main_is = "orient.ml"});
               Executable
                 ({
                     cs_name = "proof_check_tstp";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "proof_check_tstp.ml"
                   });
               Executable
                 ({
                     cs_name = "detect_theories";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "detect_theories.ml"});
               Executable
                 ({
                     cs_name = "resolution1";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "parsers",
                                OASISExpr.EFlag "demo"),
                             true)
                        ];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "src/demo/resolution";
                      bs_compiled_object = Native;
                      bs_build_depends =
                        [
                           InternalLibrary "libzipperposition";
                   ...
                   {exec_custom = false; exec_main_is = "resolution1.ml"});
               SrcRepo
                 ({
                     cs_name = "head";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      src_repo_browser =
                        Some
                          "https://github.com/c-cube/zipperposition/tree/master/src";
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\t?\031\142\159\155\1934\n0\206\141\162\015'q";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
