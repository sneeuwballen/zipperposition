...
(* OASIS_START *)
(* DO NOT EDIT (digest: d20688d79b32d212c3eebaa648cb50cd) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [("builtin.theory", None)];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "libzipperposition";
                           FindlibPackage
                             ("libzipperposition.arbitrary", None);
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "q\181U\2030'\018X{\2255u\207\142\214\192";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
