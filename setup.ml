...
(* OASIS_START *)
(* DO NOT EDIT (digest: e4e7f77d80f978ac1a5aba9799c1b0c5) *)
(*
...
let setup_t =
  {
                 ...
                 ({
                      ...
                      },
                   {
                      ...
                      lib_internal_modules =
                        [
                           "containers/PersistentGraph";
                           "containers/Hashset";
                           "containers/PHashtbl";
                           "containers/PersistentHashtbl";
                           "containers/Heap";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\004P\030\200\135\150\143\240k\147r\026_y\151\206";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
