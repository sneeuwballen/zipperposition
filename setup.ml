...
(* OASIS_START *)
(* DO NOT EDIT (digest: 29a7667506117231dc270a0822a41d01) *)
(*
...
let setup_t =
  {
     ...
     doc = [("zipperposition", OCamlbuildDocPlugin.doc_build ".")];
     ...
     clean_doc = [("zipperposition", OCamlbuildDocPlugin.doc_clean ".")];
     distclean = [];
     distclean_test =
       [
          ("all",
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["ArMonome"; "ArArith"; "ArInterval"];
                      lib_pack = true;
                      lib_internal_modules = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "h@\205\190\223\222D\130d\170\022T\026\214.L";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
