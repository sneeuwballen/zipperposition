...
(* OASIS_START *)
(* DO NOT EDIT (digest: fdccbdb41a9340321f8483a91ce9d4c1) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/c-cube/logtk";
          synopsis =
            "Logic toolkit, designed primarily for first-order automated reasoning.";
          description =
            Some
              [
                 OASISText.Para
            ...
            [
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$docdir";
                      doc_title = "Logtk_meta documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "type_check_tptp.ml"});
               Executable
                 ({
                     cs_name = "cnf_of_tptp";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "cnf_of_tptp.ml"});
               Executable
                 ({
                     cs_name = "orient";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "hysteresis.ml"});
               Executable
                 ({
                     cs_name = "logtk_resolution1";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               SrcRepo
                 ({
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "https://github.com/c-cube/logtk";
                      src_repo_browser =
                        Some
                          "https://github.com/c-cube/logtk/tree/master/src";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "l\181\255B\0308 \004\146\236\185\138\218'Q\147";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
