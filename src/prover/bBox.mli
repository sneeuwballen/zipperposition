...
val find_boolean_lit : flex_ref:Flex_state.t ref -> Literals.t -> t option
...
val inject_lits : flex_ref:Flex_state.t ref -> Literals.t -> t
...
val inject_lit : flex_ref:Flex_state.t ref -> Literal.t -> t option
...
val inject_lemma : flex_ref:Flex_state.t ref -> Cut_form.t -> t
...
val inject_case : flex_ref:Flex_state.t ref -> inductive_case list -> t
(** Inject [cst = case] *)
