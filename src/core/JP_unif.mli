...
val project_onesided : scope:Scoped.scope -> T.t -> subst OSeq.t

val imitate : scope:Scoped.scope -> T.t -> T.t -> (T.var * int) list -> subst OSeq.t

val identify : scope:Scoped.scope -> T.t -> T.t -> (T.var * int) list -> subst OSeq.t

val eliminate : scope:Scoped.scope -> T.t -> T.t -> (Type.t HVar.t * int) list -> subst OSeq.t
...
val unify : scope:Scoped.scope -> T.t -> T.t -> subst option OSeq.t
