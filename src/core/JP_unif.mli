...
val project_onesided :
  scope:Scoped.scope -> counter:int ref -> T.t -> subst OSeq.t

val imitate_onesided :
...
val unify :
  scope:Scoped.scope -> counter:int ref -> T.t -> T.t -> subst option OSeq.t
