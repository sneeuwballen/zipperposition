...
let equal c1 c2 =
  T.equal c1.t1 c2.t1 && T.equal c1.t2 c2.t2 && c1.sc1 = c2.sc1
  && c1.sc2 = c2.sc2

let compare c1 c2 : int =
  let open CCOrd.Infix in
  T.compare c1.t1 c2.t1 <?> (T.compare, c1.t2, c2.t2)
...
module FO = struct
  let make ~tags (t1, sc1) (t2, sc2) =
    make ~tags ((t1 : Term.t :> T.t), sc1) ((t2 : Term.t :> T.t), sc2)
end
