...
val parent_of : ord:ordering -> clause_dag -> hclause -> hclause -> clause_dag

(** update the DAG using the list of parents of the clause *)
val update : ord:ordering -> clause_dag -> hclause -> clause_dag
val updates : ord:ordering -> clause_dag -> hclause list -> clause_dag

(** get the list of descendants of clause. Selected literals are not
    taken into account in hashconsing. *)
val descendants : ord:ordering -> clause_dag -> hclause -> hclause list
