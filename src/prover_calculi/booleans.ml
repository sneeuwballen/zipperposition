...
module Make (E : Env.S) : S with module Env = E = struct
  ...
  let fluid_log_hoist (c : C.t) =
    ...
    let y_quant =
      Lambda.eta_expand
      @@ T.var (HVar.fresh ~ty:(Type.arrow [ a ] Type.prop) ())
    in
    ...
    let partners =
      [
        ...
        {
          unif_partner = F.and_ T.true_ T.true_;
          repl = T.true_;
          new_lit = None;
        };
        {
        ...
        {
          unif_partner = F.or_ T.true_ T.false_;
          repl = T.true_;
          new_lit = None;
        };
        {
          unif_partner = F.or_ T.false_ T.true_;
          repl = T.true_;
          new_lit = None;
        };
        ...
        {
          unif_partner = F.imply T.true_ T.true_;
          repl = T.true_;
          new_lit = None;
        };
      ]
