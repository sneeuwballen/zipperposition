...
module Make (E : Env_intf.S) = struct
  ...
  let narrow_term_passive =
    Util.with_prof prof_narrowing_term narrow_term_passive_
  ...
  let narrow_lits lits = Util.with_prof prof_narrowing_lit narrow_lits_ lits
