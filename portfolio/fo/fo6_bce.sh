...
$DIR/../zipperposition ${1:+"$1"} \
  ...
  --select=e-selection15 --kbo-const-weight=1 \
  --bce=true --pred-elim=true --bce-max-symbol-occurences=512\
  --pred-elim-max-resolvents=512 --pred-elim-check-gates=true --pred-elin-only-non-conjecture-gates=true --pred-elim-check-gates-semantically=true \
  --pred-elim-measure-fun=relaxed --pred-elim-relax-value=0\
  "${@:3}"
