...
$DIR/zipperposition ${1:+"$1"} \
  ...
  --ho-unif-max-depth=1 --ho-max-app-projections=0 --ho-max-rigid-imitations=1 --ho-max-elims=0 --ho-max-identifications=0\
  ...
  --prec-gen-fun=invfreq_conj  --lazy-cnf-renaming-threshold=3\
  --kbo-weight-fun-from-precedence=true --trigger-bool-inst=1\
  --tptp-def-as-rewrite --rewrite-before-cnf=true\
  --trigger-bool-ind=1 --lazy-cnf=true --lazy-cnf-kind=simp --select=e-selection\
  --lazy-cnf-inf-quant=true --timeout=20 --ho-selection-restriction=none "${@:4}"
