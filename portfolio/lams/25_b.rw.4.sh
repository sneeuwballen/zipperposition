...
$DIR/../zipperposition ${1:+"$1"} \
  ...
  --try-e="$DIR/eprover-ho" --tmp-dir="$3" --e-timeout=15 --e-auto=true --e-max-derived=50 --e-encode-lambdas=drop\
  --scan-clause-ac=false --presaturate=true --e-call-point=0.22 "${@:4}"
