...
$DIR/../zipperposition ${1:+"$1"} \
  ...
  --try-e="$DIR/eprover-ho" --tmp-dir="$3" --e-timeout=35 --e-max-derived=48 --e-encode-lambdas=keep\
  --presaturate=true --prec-gen-fun=invfreq --e-call-point=0.08 --sine-trim-implications=true "${@:4}"
