...
$DIR/zipperposition ${1:+"$1"} \
  ...
  --select=NoSelection --prec-gen-fun=invfreq_conj --kbo-weight-fun=lambda-def-modarity  --ord=derived_ho_kbo \
  ...
  --lazy-cnf=true --lazy-cnf-kind=inf --lazy-cnf-renaming-threshold=4 \
  --sine=100 --sine-depth-min=1 --sine-depth-max=5 --sine-tolerance=1.5 --sine-trim-implications=true\
  --presaturate=true --bool-select="sel2(neg_ctx)"\
