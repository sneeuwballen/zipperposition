...
$DIR/zipperposition ${1:+"$1"} \
  ...
  --select=e-selection7 --ho-choice-inst=true --try-e="$DIR/eprover-ho" --tmp-dir="$3" --e-timeout=2 --e-auto=true \
  ...
  --solid-subsumption=true --ignore-orphans=true --e-call-point=0.2 "${@:4}"
