...
https://travis-ci.org/c-cube/zipperposition[image::https://api.travis-ci.org/c-cube/zipperposition.svg?branch=master[link="https://travis-ci.org/c-cube/zipperposition", alt="Build status on travis"]]
...
If you have installed https://github.com/c-cube/qcheck/[qcheck]
and https://github.com/mirage/alcotest/[alcotest], for instance
